...
console.log('borrow.bob debtUSD       =', await resolveText('borrow.bob.seikine.eth', 'seikine:debtUSD'));
console.log('lend.bob   collateralUSD =', await resolveText('lend.bob.seikine.eth', 'seikine:collateralUSD'));
