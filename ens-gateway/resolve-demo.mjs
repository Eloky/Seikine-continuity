...
console.log('borrow.demo debtUSD       =', await resolveText('borrow.demo.seikine.eth', 'seikine:debtUSD'));
console.log('lend.demo   collateralUSD =', await resolveText('lend.demo.seikine.eth', 'seikine:collateralUSD'));
